...
router.post('/', (req, res, next) => {
        ...
        // 쿼리 명령문 (Insert) 
        const insert_Query = "Insert Into projects (project_index, project_title, project_department, project_users, project_startDay, project_endDay, project_purpose) VALUES (0,'" + 
        req.body.title + "', '" + req.body.department + "', '" + req.body.users + "', '" + req.body.startDay + "', '" + req.body.endDay + "', '" + req.body.purpose + "')";
